...
class InventoryCommand:
    def __init__(self):
        self.iconPath = str(ICON_DIR / 'inventory.svg')
    ...
    def __init__(self):
        ...
        for obj in inventory:
            ...
            if "AnnotationPlane" == getType(obj):
                ...
                self.dialogWidgets.append( fieldLabeCombolWidget_inv(Text='Tolerance value:', List=featureControlFrame.Label, Circumference=['', ICON_DIR / 'diameter.svg'] , Icons=featureControlFrame.Icon, ToolTip=featureControlFrame.toolTip, Data = self.data, Obj = obj) ) #http://doc.qt.io/qt-5/qlineedit.html#inputMask-prop
